...
(function ($) {
    ...
    BootstrapPaginator.prototype = {
        ...
        render: function () {
            ...
            var itemHtml = "<span><input type='text' style='width: 30px;height: 20px; border: solid 1px #337ab738; border-radius: 5px;' value='"+this.currentPage+"'/>/"+this.totalPages+"</span>";
            itemCustom.append(itemHtml);
            listContainer.append(itemCustom);
            var itemlast = $("<li></li>");//创建一个‘跳转’的span
            var itemTz = $("<span><a> 跳转</a></span>").on("click",null,{type: 'jump'},$.proxy(this.onPageItemJumped, this));//绑定点击事件
